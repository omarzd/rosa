...
object LinearFixedpoint {
  ...
  def ballBeam(state1: Real, state2: Real, state3: Real, state4: Real): Real = {
    require(state1 >< (0.0, 1.0) && state2 >< (-0.5, 0.5) && state3 >< (0, 0.5)
      && state4 >< (0, 0.5))
  ...
  def batchReactorOut1(state1: Real, state2: Real, state3: Real, state4: Real): Real = {
    require(state1 >< (-1.0, 1.0) && state2 >< (-1.0, 1.0) && state3 >< (-1.0, 1.0)
      && state4 >< (-1.0, 1.0))
  ...
  def batchReactorState1(state1: Real, state2: Real, state3: Real, state4: Real, y1: Real, y2: Real): Real = {
    require(state1 >< (-1.0, 1.0) && state2 >< (-1.0, 1.0) && state3 >< (-1.0, 1.0) &&
      state4 >< (-1.0, 1.0) && y1 >< (-1.0, 1.0) && y2 >< (-1.0, 1.0))
  ...
  def trancair4Out(state0: Real, state1: Real, state2: Real, state3: Real, state4: Real,
    ...
    require(state0 >< (-2.5, 6.5) && state1 >< (-2.5, 6.5) && state2 >< (-2.5, 6.5) &&
      state3 >< (-2.5, 6.5) && state4 >< (-2.0, 12.0) && state4 >< (-2.0, 12.0) &&
      state5 >< (-2.0, 12.0) && state6 >< (-2.0, 12.0) && state7 >< (-2.0, 12.0) && state8 >< (-2.0, 12.0))
  ...
  def trancair4State1(state0: Real, state1: Real, state2: Real, state3: Real, state4: Real,
    ...
    require(state0 >< (-2.5, 6.5) && state1 >< (-2.5, 6.5) && state2 >< (-2.5, 6.5) &&
      state3 >< (-2.5, 6.5) && state4 >< (-2.0, 12.0) && state4 >< (-2.0, 12.0) &&
      state5 >< (-2.0, 12.0) && state6 >< (-2.0, 12.0) && state7 >< (-2.0, 12.0) &&
      state8 >< (-2.0, 12.0) && y0 >< (-2, 12.0) && y1 >< (-2, 12.0) && y2 >< (-2, 12.0) &&
      y3 >< (-2, 12.0) && y4 >< (-2, 12.0))
