...
object Discontinuity {
  ...
  def naturalSpline(x: Real): Real = {
    ...
    if (x <= 1) {
      2.8 * x - 0.8*x*x*x         
       ...
       x*x*x - 5.4*x*x + 8.2*x - 1.8
       
    } else {
      -0.2*x*x*x + 1.8*x*x - 6.2*x + 7.8
    }
  ...
  def styblinski(x: Real, y: Real): Real = {
    ...
    if (y <= 0)
      if (x <= 0)
        4.43803 + 5.8375*x + 1.3875*x*x + 5.91829*y + 2.92311e-15*x*y + 1.36286*y*y   // x<=0&&y<=0
      else 
        4.05 - 5.3375*x + 1.3875*x*x + 5.8375*y - 6.64404e-16*x*y + 1.3875*y*y   // x>=0&&y<=0
    else 
      if (x <= 0)
        4.05 + 5.8375*x + 1.3875*x*x - 5.3375*y + 1.18116e-15*x*y + 1.3875*y*y   // x<=0&&y>=0
      else 
        4.05 -5.3375*x + 1.3875*x*x - 5.3375*y - 7.38226e-17*x*y + 1.3875*y*y   // x>=0&&y>=0
  } ensuring (res => res +/- 1e-5)
  ...
  def sortOfStyblinski(x: Real, y: Real): Real = {
    ...
    if (y < x)
      -2.60357 + 0.25*x + 0.369643*x*x + 0.889286*y - 4.32143e-16*x*y - 0.896429*y*y    //y<x
    else
      -3.76071 + 0.25*x + 0.369643*x*x + 0.889286*y + 5.08864e-16*x*y - 0.703571*y*y   //x<y
