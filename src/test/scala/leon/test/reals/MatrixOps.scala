...
class MatrixOps extends LeonTestSuite {
  ...
  val m6 = RMatrix.fromDoubles(Seq(Seq(1.0125958110204192, 0.0, 0.022617800112495742, 0.1, 0.0 , 0.0005958662735577874),
                   Seq(0.005921762731020502, 1.0, 0.007539266704165247, 0.0, 0.0, 0.04413821270376106),
                   Seq(0.017765288193061505, 0.0, 1.0219721471017966, 0.0, 0.1, 0.0007944883647437166),
                   Seq(0.12595811020419093, 0.0, 0.22617800112495742, 1.0, 0.0, 0.005958662735577875),
                   Seq(0.17765288193061504, 0.0, 0.2197214710179657, 0.0, 1.0, 0.007944883647437166),
                   Seq(0.0005921762731020501, 0.1, 0.0007539266704165247, 0.0, 0.0, 0.9993808299347923)))
