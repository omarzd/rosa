...
object PrettyPrinter {
  ...
  private def pp(tree: Expr, sb: StringBuffer, lvl: Int): StringBuffer = tree match {
    ...
    case FUMinus(expr) => ppUnary(sb, expr, "-(", ")", lvl)
    ...
    case FPlus(l,r) => ppBinary(sb, l, r, " + ", lvl)
    case FMinus(l,r) => ppBinary(sb, l, r, " - ", lvl)
    case FTimes(l,r) => ppBinary(sb, l, r, " * ", lvl)
    case FDivision(l,r) => ppBinary(sb, l, r, " / ", lvl)
  ...
  private def pp(tpe: TypeTree, sb: StringBuffer, lvl: Int): StringBuffer = tpe match {
    ...
    case Float64Type => sb.append("Float")
