 ...
 */
case class VerificationCondition(val inputs: Map[Variable, RationalInterval], val expr: Expr,
  val output: Option[RationalInterval] = None, val absRoundoff: Option[Rational] = None) {
